...
product1 = Product.create(name: FFaker::Product.name, description: 'some description placeholder', price: 11.99, rating: 4, image_url: "https://www.placecage.com/200/300")
...
product3 = Product.create(name: FFaker::Product.name, description: 'some description placeholder', price: 11.99, rating: 4, image_url: "https://www.placecage.com/200/300")
product4 = Product.create(name: FFaker::Product.name, description: 'some description placeholder', price: 11.99, rating: 4, image_url: "https://www.placecage.com/200/300")
